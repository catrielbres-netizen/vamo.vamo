...
const serviceStyles: Record<ServiceType, string> = {
    professional: "bg-yellow-400/20 text-yellow-500 border-yellow-400/30 hover:bg-yellow-400/30",
    express: "bg-violet-400/20 text-violet-500 border-violet-400/30 hover:bg-violet-400/30",
    shared: "bg-indigo-400/20 text-indigo-500 border-indigo-400/30 hover:bg-indigo-400/30",
};
