...
async function run() {
    ...
    console.log("Loading functions/src/sharedRides dynamically...");
    const { dispatchSharedRideGroupIfReady, performFullSharedRideCancellation } = await import('../functions/src/sharedRides.ts');
